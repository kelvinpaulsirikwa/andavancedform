...
@section('title', 'Filtered by Age – ' . config('advancedforms.appname', config('app.name')))
...
@section('content')
    <main>
        <div class="card">
            ...
            <h2>Filtered Responses: {{ $filterType }} - {{ $filterValue }} years</h2>
            
            <div class="filter-info">
                <strong>Filter:</strong> {{ $filterType }} = {{ $filterValue }} years | 
                        ...
                        <a href="{{ route('dashboard.response', $response->id) }}" style="text-decoration: none; color: inherit;">
                            <div class="response-item" style="cursor: pointer;">
                                ...
                                <div class="response-details">
                                    <strong>Age:</strong> {{ $response->age ?? 'N/A' }} years<br>
